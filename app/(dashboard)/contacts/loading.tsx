    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <Skeleton className="h-4 w-48 rounded-[6px] mt-2" />
        </div>
          ...
          <TableBody>
            {Array.from({ length: 6 }).map((_, i) => (
              <TableRow key={i} className="border-b border-border/60 last:border-0">
                <TableCell className="py-3.5"><Skeleton className="h-5 w-24 rounded" /></TableCell>
                <TableCell className="py-3.5"><Skeleton className="h-4 w-40 rounded" /></TableCell>
