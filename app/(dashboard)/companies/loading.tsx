    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <Skeleton className="h-4 w-44 rounded-[6px] mt-2" />
        </div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent border-b border-border bg-secondary/20">
              ...
              <TableHead className="w-[20%] h-10"><Skeleton className="h-3 w-16 rounded" /></TableHead>
              <TableHead className="w-[20%] h-10"><Skeleton className="h-3 w-16 rounded" /></TableHead>
              <TableHead className="w-[20%] h-10"><Skeleton className="h-3 w-12 rounded" /></TableHead>
              <TableHead className="w-[20%] h-10 text-right"><Skeleton className="h-3 w-16 rounded ml-auto" /></TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {Array.from({ length: 6 }).map((_, i) => (
              <TableRow key={i} className="border-b border-border/60 last:border-0">
                ...
                <TableCell className="py-3.5"><Skeleton className="h-4 w-20 rounded" /></TableCell>
                <TableCell className="py-3.5"><Skeleton className="h-4 w-28 rounded" /></TableCell>
                <TableCell className="py-3.5"><Skeleton className="h-4 w-14 rounded" /></TableCell>
